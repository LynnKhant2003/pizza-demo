            ...
            <div class="col-md-9">
              ...
              <div class="card">
                <div class="card-header p-2">
                  <legend class="text-center">Edit Pizza Data</legend>
                </div>
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                        <div class="mb-2 text-center">
                            <img src="{{asset('/uploads/'.$data->image)}}" alt="" style="width: 30%; height: 30%" class="border rounded-circle ">
                        </div>
                      <form class="form-horizontal" action="{{route('admin#updatePizza',$data->pizza_id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                          <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName" placeholder="Name" value="{{old('name',$data->name)}}" name="name">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputName" placeholder="Price" value="{{old('price',$data->price)}}" name="price">
                              @if($errors->has('price'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputName" placeholder="Discount price" value="{{old('discount',$data->discount_price)}}" name="discount">
                              @if($errors->has('name'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10 mt-2">
                                ...
                                <input type="radio" name="b1g1" id="" value="0" checked>No
                                @else
                                <input type="radio" name="b1g1" id="" value="1" checked>Yes
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputName" placeholder="Name" value="{{old('wait',$data->waiting_time)}}" name="wait">
                              @if($errors->has('wait'))
